...
interface Plan {
  ...
  ctaText: string;
  ctaLink: string;
  ctaMonthlyLink?: string;
  ctaAnnualLink?: string;
}
...
const plans: Plan[] = [
  ...
  },
  {
    ...
    ctaMonthlyLink: 'https://clkdmg.site/subscribe/oferta-de-lancamento-arremataai',
    ctaAnnualLink: 'https://clkdmg.site/subscribe/oferta-de-lancamento-gold-anual'
  },
  {
    name: 'DIAMOND',
    monthlyPrice: 147,
...
export default function Pricing() {
  ...
  // Função para obter o link correto baseado no plano e período
  const getCtaLink = (plan: Plan) => {
    if (plan.name === 'GOLD') {
      return isAnnual ? plan.ctaAnnualLink! : plan.ctaMonthlyLink!;
    }
    return plan.ctaLink;
  };
